<%@ Control Language="VB" AutoEventWireup="false" CodeFile="RmbSubActCIDA.ascx.vb" Inherits="controls_RmbSubActCIDA" ClassName="controls_RmbSubActCIDA"  %>
...
<tr id="ReceiptLine" runat="server">
    <td><b><dnn:label  id="ttlReceipt"   runat="server" controlname="ddlReceipt" ResourceKey="lblReceipt" /></b></td>
    <td>

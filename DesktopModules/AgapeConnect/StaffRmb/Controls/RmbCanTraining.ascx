<%@ Control Language="VB" AutoEventWireup="false" CodeFile="Copy of RmbConfAtt.ascx.vb" Inherits="controls_RmbConfProv" ClassName="controls_RmbConfProv"  %>
...
<tr>
    <td><b><dnn:label id="Label1"  runat="server" controlname="dtDate" ResouceKey="lblDate"  text="Date:" /></b></td>
    <td colspan="2">

...
namespace StaffRmb
{
    ...
    partial void DeleteAP_ExchangeRate(AP_ExchangeRate instance);
		...
		public System.Data.Linq.Table<AP_Staff_Rmb_Post_Extra> AP_Staff_Rmb_Post_Extras
		{
			get
			{
    ...
    partial void OnPrivCommentChanging(string value);
    partial void OnPrivCommentChanged();
    #endregion
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_PrivComment")]
		public string PrivComment
		{
			get
			{
				return this._PrivComment;
			}
			set
			{
				if ((this._PrivComment != value))
				{
					this.OnPrivCommentChanging(value);
					this.SendPropertyChanging();
					this._PrivComment = value;
					this.SendPropertyChanged("PrivComment");
					this.OnPrivCommentChanged();
				}
			}
		}
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="AP_Staff_Rmb_AP_Staff_Rmb_Post_Extra", Storage="_AP_Staff_Rmb_Post_Extras", ThisKey="RMBNo", OtherKey="RMBNo")]
		public EntitySet<AP_Staff_Rmb_Post_Extra> AP_Staff_Rmb_Post_Extras
		{
			get
			{
				return this._AP_Staff_Rmb_Post_Extras;
			}
			set
			{
				this._AP_Staff_Rmb_Post_Extras.Assign(value);
			}
		}
		...
		private void attach_AP_Staff_Rmb_Post_Extras(AP_Staff_Rmb_Post_Extra entity)
		{
			this.SendPropertyChanging();
			entity.AP_Staff_Rmb = this;
		}
    ...
    partial void OnSupplierChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_ExchangeRate")]
	...
	[global::System.Data.Linq.Mapping.TableAttribute(Name="dbo.AP_Staff_Rmb_Post_Extra")]
	public partial class AP_Staff_Rmb_Post_Extra : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private string _RemitToAddress;
    ...
    partial void OnRemitToAddressChanging(string value);
    partial void OnRemitToAddressChanged();
    partial void OnVoucherNumberChanging(string value);
    partial void OnVoucherNumberChanged();
    #endregion
		
		public AP_Staff_Rmb_Post_Extra()
		{
			this._AP_Staff_Rmb = default(EntityRef<AP_Staff_Rmb>);
			OnCreated();
		}
		
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_RMBNo", AutoSync=AutoSync.OnInsert, DbType="BigInt NOT NULL", IsPrimaryKey=true)]
		public long RMBNo
		{
			get
			{
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_BatchId", DbType="NVarChar(255)")]
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_VendorId", DbType="NVarChar(255)")]
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_RemitToAddress", DbType="NVarChar(255)")]
		public string RemitToAddress
		{
			get
			{
				return this._RemitToAddress;
			}
			set
			{
				if ((this._RemitToAddress != value))
				{
					this.OnRemitToAddressChanging(value);
					this.SendPropertyChanging();
					this._RemitToAddress = value;
					this.SendPropertyChanged("RemitToAddress");
					this.OnRemitToAddressChanged();
				}
			}
		}
		
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_VoucherNumber", DbType="Char(21)")]
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="AP_Staff_Rmb_AP_Staff_Rmb_Post_Extra", Storage="_AP_Staff_Rmb", ThisKey="RMBNo", OtherKey="RMBNo", IsForeignKey=true)]
		public AP_Staff_Rmb AP_Staff_Rmb
		{
			get
			{
			...
			set
			{
							...
							|| (this._AP_Staff_Rmb.HasLoadedOrAssignedValue == false)))
				{
					...
					{
						this._AP_Staff_Rmb.Entity = null;
						previousValue.AP_Staff_Rmb_Post_Extras.Remove(this);
					}
					this._AP_Staff_Rmb.Entity = value;
					if ((value != null))
					{
						value.AP_Staff_Rmb_Post_Extras.Add(this);
						this._RMBNo = value.RMBNo;
					}
					else
					{

                                                ...
                                                <asp:TemplateField HeaderText="Line Type" SortExpression="LineType" ItemStyle-Width="110px">
                                                    ...
                                                    <ItemTemplate>
                                                        ...
                                                        <asp:Panel runat="server">
                                                            ...
                                                            <asp:Label ID="lblPerDiemMeals" runat="server" CssClass=<%# "second_line " & if(IsAccounts(),"finance","") %> Visible=<%# If(ShowSecondTypeRow(Eval("LineType")),"True","False") and IsAccounts() %> Text=<%# If(Eval("Spare5") IsNot Nothing , Eval("Spare5"),"") %>></asp:Label>
                                                        </asp:Panel>
                                                    </ItemTemplate>

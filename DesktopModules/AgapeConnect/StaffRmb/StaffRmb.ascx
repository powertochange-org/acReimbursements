 ...
 function showSuggestedPayments() {
    ...
    function eventBritePrompt(sender) {
        ...
        if (supplier.indexOf('event') >= 0 && (supplier.indexOf('brite') >= 0  || supplier.indexOf('bright') >=0)) {
            alert('If this reimbursement is for multiple EventBrite tickets, please attach the tickets and the Order Summary.')
        }
    }
                                                ...
                                                <asp:TemplateField HeaderText="Line Type" ItemStyle-Width="110px">
                                                    ...
                                                    <ItemTemplate>
                                                        ...
                                                        <asp:Panel runat="server">
                                                            <asp:Label ID="lblToFrom" runat="server" CssClass=<%# "second_line " & if(IsAccounts(),"finance","") %>  Visible=<%# If(TypeHasOriginAndDestination(Eval("LineType")),"True","False") %> Text=<%# If(Eval("Spare4") IsNot Nothing And Eval("Spare5") IsNot Nothing, AbbreviatedOrigDest(Eval("Spare4"),Eval("Spare5")),"") %>></asp:Label>
            ...
            <ContentTemplate>
                ...
                <table style="width:100%; padding:20px;">
                    ...
                    <tr><td><asp:Label ID="lblBatchId" runat="server" resourcekey="BatchId" /></td>
                        <td><asp:TextBox ID="tbBatchId" runat="server" MaxLength="15" Name="batchId" AutoCompleteType="none"/></td></tr>

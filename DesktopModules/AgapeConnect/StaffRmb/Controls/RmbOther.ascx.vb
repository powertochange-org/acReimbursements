...
Partial Class controls_RmbOther
    ...
    Public Property Taxable() As Boolean
        Get
            Return ddlType.SelectedValue = "True"

        End Get
        Set(ByVal value As Boolean)
            If value = True Then
                ddlType.SelectedValue = "True"
            Else
                ddlType.SelectedValue = "False"
            End If
        End Set
    End Property
    ...
    Public Function ValidateForm(ByVal userId As Integer) As Boolean
        ...
        Try
            ...
            If ddlReceipt.SelectedValue = "-1" And theAmount > CDbl(hfNoReceiptLimit.Value) Then
                ...
                ErrorLbl.Text = DotNetNuke.Services.Localization.Localization.GetString("AmountRec.Error", LocalResourceFile).Replace("[LIMIT]", StaffBrokerFunctions.GetSetting("Currency", PS.PortalId) & hfNoReceiptLimit.Value)
                ddlReceipt.SelectedValue = 1
                Return False
            End If
        Catch ex As Exception

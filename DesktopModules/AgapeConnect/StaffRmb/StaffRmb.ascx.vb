        ...
        Public Async Function LoadRmbAsync(ByVal RmbNo As Integer) As Task
            ...
            Try
                ...
                If q.Count > 0 Then
                    ...
                    enableSubmitButton(btnSubmit.Visible And tbChargeTo.Text.Length = 6 And ((Not ddlApprovedBy.SelectedValue.Equals(String.Empty)) AndAlso ddlApprovedBy.SelectedValue >= 0))

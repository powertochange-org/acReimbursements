<%@ Control Language="VB" AutoEventWireup="false" CodeFile="RmbLandline.ascx.vb" Inherits="controls_RmbLandline" ClassName="controls_RmbLandline"  %>
...
<tr id="ReceiptLine" runat="server">
    <td><b><dnn:label id="Label3"  runat="server" controlname="ddlReceipt"  ResourceKey="lblReceipt"/></b></td>
    <td>

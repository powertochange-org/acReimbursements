<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Mobile.aspx.vb" Inherits="DesktopModules_AgapeConnect_StaffRmb_Mobile" %>
...
<body>
    <div ID="home" data-role="page">
	    ...
	    <div data-role="content">	
            ...
            <div>
                <a href="#my_active_list" >My Active Reimbursements</a>
            </div>
	    </div><!-- /content -->
    </div><!-- /page -->
    ...
    <div ID="my_active_list" data-role="page">
	    ...
	    <div data-role="content">	
            <div>
                <a href="#rmb_details" >Reimbursement Details</a>
            </div>
	    </div><!-- /content -->
    </div><!-- /page -->
    ...
    <div id="rmb_details" data-role="page">
	    ...
	    <div data-role="content">	
            <form runat="server">
                ...
                <asp:HiddenField ID="hfRmbNo" runat="server" Value="10066" />

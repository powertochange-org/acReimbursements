...
public class WebService : System.Web.Services.WebService {
    ...
    public void getStaffAppsButtonResponsive()
    {
        ...
        String SCRIPT = "<script type='text/javascript'>function staffAppsMenuShow() {$('#staffAppsMenu').show();var e = document.getElementById('staffAppsButton');e.style.background = '#f4f4f4';e.style.border = '1px solid #d6d7d4';e.style.borderBottom = '1px solid #f4f4f4';}" +
               ...
               "function trackStaffAppsMenuClick(Label) {'use strict'; console.debug('tracking label: '+Label); if (typeof (_gaq) !== 'undefined') { console.debug('_gaq'); _gaq.push(['_trackEvent', 'Staff Apps Menu', 'click', Label, '1']); } else if (typeof (ga) !== 'undefined') { console.debug('ga'); ga('send', 'event', 'Staff Apps Menu', 'click', Label, '1');}}</script>";

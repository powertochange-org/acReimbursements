                                                ...
                                                <asp:TemplateField HeaderText="Line Type" SortExpression="LineType" ItemStyle-Width="110px">
                                                    ...
                                                    <ItemTemplate>
                                                        ...
                                                        <asp:Panel runat="server">
                                                            <asp:Label ID="lblToFrom" runat="server" Font-Size="XX-Small" ForeColor="#AAAAAA" Font-Names="Courier" Visible=<%# If(Eval("LineType")=31 or Eval("LineType")=61,"True","False") %> Text=<%# If(Eval("Spare4") IsNot Nothing And Eval("Spare5") IsNot Nothing, Left(Eval("Spare4"),9) & " - " & Left(Eval("Spare5"),9),"") %>></asp:Label>
                                                        </asp:Panel>
                                                    </ItemTemplate>
